...
do
	../bin/${comp}_compute_flowmap $nDim $tEval ${source_folder}/coords.txt ${source_folder}/faces.txt ${source_folder}/times.txt ${source_folder}/velocity.txt $nRK4 $sched $toFile > ${nDim}D_${N}K_${comp}_${th}th_sched${sched}.txt
done
